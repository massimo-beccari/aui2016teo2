...
public class BlueTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(BlueTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void go() throws Exception {
        ...
        os.write("p".getBytes()); //just send '1' to the device
        os.close();
        is.close();
    ...
    private void go2() throws Exception {
    	hc05Url = "btspp://98D331FD381F:1;authenticate=false;encrypt=false;master=false";
    	StreamConnection streamConnection = (StreamConnection) Connector.open(hc05Url);
        OutputStream os = streamConnection.openOutputStream();
        InputStream is = streamConnection.openInputStream();
